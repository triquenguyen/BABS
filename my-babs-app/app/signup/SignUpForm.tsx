      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-[20px] items-center ">
        <div className="flex gap-[20px]">
          <label className="text-[#69C9D0] flex flex-col">
            First Name
            <input type="text" name="fName" value={form.fName} onChange={handleChange} className="bg-[rgba(255,255,255,0.2)] w-[170px] border-[2px] border-[rgba(0,0,0,0)] focus:ring-[#69C9D0] focus:border-[#69C9D0] focus:outline-none text-sm rounded-lg block p-3 mt-2" />
          </label>

          <label className="text-[#69C9D0] flex flex-col">
            Last Name
            <input type="text" name="lName" value={form.lName} onChange={handleChange} className="bg-[rgba(255,255,255,0.2)] w-[170px] border-[2px] border-[rgba(0,0,0,0)] focus:ring-[#69C9D0] focus:border-[#69C9D0] focus:outline-none text-sm rounded-lg block p-3 mt-2" />
          </label>
        </div>
        <label className="text-[#69C9D0] flex flex-col">
          Email
